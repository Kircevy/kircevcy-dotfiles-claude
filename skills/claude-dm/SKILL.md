...
description: >
  ...
  Use when coordinating multiple simultaneous Claude sessions — e.g. "dm another claude", "list claude sessions", "peek peer claude", "spawn claude in tmux", "monitor remote claude", "send to peer", "orchestrate claude sessions".
---
